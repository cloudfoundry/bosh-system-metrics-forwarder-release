...
const (
	SourceType_COMPONENT   SourceType = 0
	SourceType_APPLICATION SourceType = 1
	SourceType_SERVICE     SourceType = 2
)
...
func (SourceType) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
type Envelope struct {
	...
	SourceType SourceType        `protobuf:"varint,9,opt,name=source_type,json=sourceType,enum=loggregator.v2.SourceType" json:"source_type,omitempty"`
...
func (m *Envelope) GetSourceType() SourceType {
	if m != nil {
		return m.SourceType
	}
	return SourceType_COMPONENT
}
...
func init() {
	...
	proto.RegisterEnum("loggregator.v2.SourceType", SourceType_name, SourceType_value)
...
var fileDescriptor2 = []byte{
	...
	,
}
